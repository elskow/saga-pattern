...
type orderApp struct {
	...
	participantAdapter ordersvc.FrameworkParticipant
...
func buildOrderApp(cfg commonconfig.ServiceConfig, logger *slog.Logger, db *sql.DB, runtimePublisher *commonkafka.RuntimePublisher) (*orderApp, error) {
	...
	return &orderApp{orders: orders, repo: repo, participantAdapter: frameworkParticipant, metrics: metrics, participant: participant, consumerGroup: consumerGroup}, nil
}
