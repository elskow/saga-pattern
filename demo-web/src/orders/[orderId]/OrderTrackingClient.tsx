...
export default function OrderTrackingPage() {
  ...
  const [awaitingProjection, setAwaitingProjection] = useState(false);
  ...
  }, [order?.status, awaitingProjection, fetchOrder]); // eslint-disable-line react-hooks/exhaustive-deps
