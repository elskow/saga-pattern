...
| `Saga Thesis Capture Template` | Bab IV capture contract with metrics, Tempo, Beyla, and Pyroscope guidance |
...
| `Saga Evidence Health` | verifies k6 remote-write, labels, targets, spanmetrics, Beyla, and app metrics |
