...
const (
	serviceName = "orchestration-inventory-service"
...
type rawEnv struct {
	ServerPort            int           `env:"SERVER_PORT" envDefault:"8092"`
	DatabaseURL           string        `env:"DATABASE_URL"`
	DBHost                string        `env:"DB_HOST" envDefault:"localhost"`
	DBPort                int           `env:"DB_PORT" envDefault:"5438"`
	DBName                string        `env:"DB_NAME" envDefault:"inventory_db"`
