...
public class KafkaConfig {
    ...
    public KafkaConfig(KafkaErrorHandlingProperties errorHandlingProperties) {
        this.errorHandlingProperties = errorHandlingProperties;
    }

    private DeadLetterPublishingRecoverer createDlqRecoverer(Map<String, Object> producerProps) {
    ...
    public DefaultErrorHandler errorHandler() {
        ...
        DeadLetterPublishingRecoverer recoverer = createDlqRecoverer(producerProps);
