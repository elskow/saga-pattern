...
func run() error {
	...
	logger.Info("starting orchestration payment service", "service", cfg.ServiceName, "pattern", cfg.Pattern, "addr", cfg.Address(), "consumerTopics", consumer.Topics(), "replyTopic", replyPublisher.Topic())
