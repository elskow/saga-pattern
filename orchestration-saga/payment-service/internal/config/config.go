...
const (
	serviceName = "orchestration-payment-service"
...
type rawEnv struct {
	ServerPort            int           `env:"SERVER_PORT" envDefault:"8091"`
	DatabaseURL           string        `env:"DATABASE_URL"`
	DBHost                string        `env:"DB_HOST" envDefault:"localhost"`
	DBPort                int           `env:"DB_PORT" envDefault:"5437"`
	DBName                string        `env:"DB_NAME" envDefault:"payment_db"`
